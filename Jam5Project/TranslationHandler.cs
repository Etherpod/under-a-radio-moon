...
namespace Jam5Project
{
    public static class TranslationHandler
    {
        ...
        public static string GetTranslation(string text, TextType type, bool warn)
        {
            ...
            switch (type)
            {
                ...
                case TextType.OTHER:
                    ...
                    break;
                default:
                    if (warn) Jam5Project.WriteDebugMessage($"Invalid TextType {type}");
                    return text;
            }
            ...
            if (warn)
            {
                //ShipEnhancements.WriteDebugMessage($"Defaulting to english for {text}");
            }
            ...
            if (warn)
            {
                //ShipEnhancements.WriteDebugMessage($"Defaulting to key for {text}");
            }
        ...
        public static void ReuseDialogueTranslation(string rawText, string[] oldPrefixes, string[] newPrefixes)
        {
            ...
            {
                //ShipEnhancements.WriteDebugMessage($"Couldn't find translation key {existingKey}", warning: true);
            }
        }
        ...
        {
            return str.ToUpper(TextTranslation.Get().m_language.ToCultureInfo());
        }
